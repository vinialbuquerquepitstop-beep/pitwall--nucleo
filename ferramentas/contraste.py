...
# O relatorio abaixo so roda quando este arquivo E o programa. prova_trilho.py e
# prova_grafico.py importam so o ratio(), e ate 11/08/2026 pagavam 20 linhas de
# ruido no meio da propria saida, o que atrapalha justamente a leitura do que a
# prova mediu.
