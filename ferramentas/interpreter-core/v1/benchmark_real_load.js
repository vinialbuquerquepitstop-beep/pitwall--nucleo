...
const residualAdjudicationLedgerFutureConditionSimulation =
  buildResidualAdjudicationLedger(
    reportSupplierAware,
    coreBundle,
    {
...
const residualAdjudicationLedgerNullColorSimulation =
  buildResidualAdjudicationLedger(
    reportSupplierAware,
    coreBundle,
    {
...
const residualAdjudicationLedgerCombinedMissingEvidenceSimulation =
  buildResidualAdjudicationLedger(
    reportSupplierAware,
    coreBundle,
    {
...
const summary = {
  ...
  remaining_missing_evidence_simulations: {
    distant_future_condition: {
      ...
      category:
        residualAdjudicationLedgerFutureConditionSimulation?.categories
          ?.source_unsupported_legacy_future_condition_missing || null,
      integrity:
        residualAdjudicationLedgerFutureConditionSimulation?.integrity?.pass === true
    },
    direct_color_vs_legacy_null: {
      actionable: residualAdjudicationLedgerNullColorSimulation?.actionable || null,
      category:
        residualAdjudicationLedgerNullColorSimulation?.categories
          ?.source_contradicted_legacy_null_color_missing || null,
      integrity:
        residualAdjudicationLedgerNullColorSimulation?.integrity?.pass === true
    },
    combined: {
      actionable: residualAdjudicationLedgerCombinedMissingEvidenceSimulation?.actionable || null,
      future_condition_category:
        residualAdjudicationLedgerCombinedMissingEvidenceSimulation?.categories
          ?.source_unsupported_legacy_future_condition_missing || null,
      null_color_category:
        residualAdjudicationLedgerCombinedMissingEvidenceSimulation?.categories
          ?.source_contradicted_legacy_null_color_missing || null,
      integrity:
        residualAdjudicationLedgerCombinedMissingEvidenceSimulation?.integrity?.pass === true
    }
  },
