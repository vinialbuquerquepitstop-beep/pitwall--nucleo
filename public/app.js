...
var av=falta.length?'<span class="venda-cli-falta">sem '+c(falta.join(" nem "))+"</span>":"";
return '<div class="venda-cli"><span class="venda-cli-code">'+c(v.cliente_code||"cliente")+"</span>"+av+
'<button class="btn-acao venda-cli-btn" data-acao="cli-ver" data-code="'+c(v.cliente_code||"")+'">Ver cliente</button></div>'}
...
async function abrirPainelVenda(leadId){
...
limparClienteVenda();
if(leadId)preencherClienteVenda(leadId);
...
if(!fvLeadSel&&!String(payload.comprador_nome||"").trim()){
