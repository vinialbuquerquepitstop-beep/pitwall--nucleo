-- migration aplicada: 20260826133005_fin_fatia2_importar_aplica_regras
-- fin_importar_extrato passa a rodar as regras ativas sobre os movimentos
-- RECEM-INSERIDOS (alcance nao_classificados, o seguro) e a devolver
-- classificados_por_regra. E o que faz a proxima importacao ja nascer
-- classificada. Nada fora do arquivo desta importacao e tocado.
...
-- os REVOKE/GRANT sao refeitos aqui de proposito (invariante 9).
